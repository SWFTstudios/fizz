(function () {
  ...
  function initSearchDrawer() {
    ...
    var sectionId = searchDrawer.dataset.searchSectionId || 'fizz-claude-predictive-search';
    ...
    searchDrawer.addEventListener('keydown', function (e) {
      if (window.FizzNav && window.FizzNav.trapFocus) window.FizzNav.trapFocus(e, searchDrawer);
    });
