/**
 * NF Stats — count-up numbers when the section enters the viewport.
 * Respects section data-nf-stats-animate, prefers-reduced-motion, and theme motion.
 */
(function () {
  'use strict';

  var SELECTOR = '[data-nf-stats]';
  var COUNT = '[data-nf-count]';
  ...
  function runSection(section) {
    ...
    var animate =
      section.getAttribute('data-nf-stats-animate') === 'true' && !prefersReducedMotion();
