/*
  ...
  Used by the colorways section ([data-nf-carousel]) and any rail
  marked with [data-nf-rail].
*/
(function () {
  'use strict';
  ...
  function Carousel(section) {
    ...
    this.rail = section.querySelector('[data-nf-rail]');
    this.slides = Array.prototype.slice.call(section.querySelectorAll('[data-nf-slide]'));
    this.dotsWrap = section.querySelector('[data-nf-dots]');
  ...
  Carousel.prototype.bindArrows = function () {
    var self = this;
    var prev = this.section.querySelector('[data-nf-prev]');
    var next = this.section.querySelector('[data-nf-next]');
    if (prev)
  ...
  Carousel.prototype.bindDrag = function () {
    ...
    rail.addEventListener('keydown', function (e) {
      var section = rail.closest('[data-nf-carousel]');
      if (!section) return;
      if (e.key === 'ArrowRight') {
        e.preventDefault();
        var next = section.querySelector('[data-nf-next]');
        if (next) next.click();
      } else if (e.key === 'ArrowLeft') {
        e.preventDefault();
        var prev = section.querySelector('[data-nf-prev]');
        if (prev) prev.click();
      }
    });
  };
  ...
  function init(scope) {
    scope.querySelectorAll('[data-nf-carousel]').forEach(function (el) {
